...
HyperSnap runs as an Alt-V basis shard, enabling proofs to be incorporated onto the Q network. This allows QStorage-hosted files to be used as embeds on Farcaster. Quorum integrates Farcaster feeds through the protocol and also supports direct messages via the Neynar Farcaster API.
